                    ...
                    <div class="col-lg-12">
                        <div class="header-top-one">
                            <div class="left-information">
                                ...
                                <a href="tel:+4733378901" class="email"><i class="fa-light fa-phone"></i>+91 92463 08588</a>
                            </div>
                            <div class="right-information">
                                <div class="right-information">
                                    ...
                                    <ul class="rts-dropdown-menu switcher-currency">
                                        <li class="has-child-menu">
                                            <a href="#">
                                                <span class="menu-item">Rupee</span>
                                                <i class="fa-regular fa-chevron-down"></i>
                                            </a>
                                        </li>
                                    </ul>
                    ...
                    <div class="header-one-wrapper">
                            ...
                            <div class="main-nav-one">
                                <nav>
                                    <ul>
                                        ...
                                        <li style="position: static;">
                                            <a class="nav-link" href="counsellor.php">Counsellors</a>
                                        </li>
                                        <li style="position: static;">
                        ...
                        <div class="header-right-area-one">
                            ...
                            <div class="buttons-area">
                                <a href="log-in.php" class="rts-btn btn-border">Get Started Now</a>
                            </div>
