                    ...
                    <div class="col-lg-12">
                        <div class="header-top-one">
                            <div class="left-information">
                                <a href="mailto:someone@example.com" class="email none-sm"><i class="fa-light fa-envelope"></i>info@campuscoach.in</a>
                                <a href="tel:+4733378901" class="email"><i class="fa-light fa-phone"></i>+61 012 012 445</a>
                            </div>
                            <div class="right-information">
                                <div class="right-information admin-panel">
                                            ...
                                            <ul class="sub-menu">
                                                <li class="user-profile">
                                                    <div class="profile-picture">
                                                        <img src="assets_cc/images/banner/36.png" alt="banner">
                                                        <div class="info">
                                                            <h6 class="name">MR. Bali</h6>
                                                            <a class="view-pro-file" href="my-profile.php">View Profile</a>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="my-profile.php" class="single-item">
                                                        <i class="fa-regular fa-user"></i>
                                                        <p>My Profile</p>
                                                    </a>
                                                </li>
                                                ...
                                                <li>
                                                    <a href="reviews.php" class="single-item">
                                                        <i class="fa-regular fa-star"></i>
                                                        <p>Reviews</p>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="quiz-attempts.php" class="single-item">
                                                        <i class="fa-sharp fa-light fa-bullseye-pointer"></i>
                                                        <p>My Quiz Attempts</p>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="order-history.php" class="single-item">
                                                        <i class="fa-sharp fa-light fa-bag-shopping"></i>
                                                        <p>Order History</p>
                                                    </a>
                                                </li>
                                                <li class="admin-border-top">
                                                    <a href="settings.php" class="single-item">
                                    ...
                                    <div class="header-right-area-one admin-top-area-right">
                    ...
                    <div class="header-one-wrapper">
                        ...
                        <div class="header-right-area-one">
                            ...
                            <div class="buttons-area">
                                <a href="registration.php" class="rts-btn btn-primary radious-0">Join Now</a>
                            </div>
            ...
            <div class="row">
                    ...
                    <div class="banner-content-four pt_sm--50 pt_md--50">
                        <div class="title-area-left-2">
                            ...
                            <div class="banner-btn-author-wrapper">
                                <a href="#" class="rts-btn btn-primary radious-0">Joint Live Class</a>
                ...
                <div class="col-lg-6 order-xl-2 order-lg-2 order-md-1 order-sm-1 order-1">
                    <div class="thumbnail-right-banner-4">
                        <img src="assets_cc/images/banner/04.jpg" alt="banner">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="about-area-left-four">
                        <div class="thumbnail-left-image">
                            <img src="assets_cc/images/about/04.jpg" alt="about">
                        </div>
                        <div class="thumbnail-right-image">
                            <img src="assets_cc/images/about/05.jpg" alt="about">
                        </div>
                        <div class="award-image-badge">
                            <img src="assets_cc/images/about/02.png" alt="about">
                        </div>
                ...
                <div class="col-lg-6 mt_md--120 mt_sm--100">
                    ...
                    <div class="about-content-right-4">
                        <div class="title-area-left-2">
                            <div class="pre-title">
                                <img src="assets_cc/images/banner/12.png" alt="banner">
                                <span>About Us</span>
                            </div>
                        ...
                        <div class="about-card-wrapper-main">
                            ...
                            <div class="single-card-about">
                                <div class="icon">
                                    <img src="assets_cc/images/about/icon/03.png" alt="about-icon">
                                </div>
                            ...
                            <div class="single-card-about">
                                <div class="icon">
                                    <img src="assets_cc/images/about/icon/04.png" alt="about-icon">
                                </div>
                                <div class="information">
                        ...
                        <div class="about-bottom-button-area-4">
                            <a href="about.php" class="rts-btn btn-primary radious-0">About Us</a>
                            <!-- author mid start -->
                            <div class="author-about">
                                <img src="assets_cc/images/about/01.png" alt="about">
                                <div class="information">
                                    <h6 class="title">Devid Jon</h6>
                                    <p>CEO, Campus Coach | Guiding Future</p>
                                </div>
                            </div>
                            <!-- author mid end -->
                            <div class="video-classes">
                                <div class="icon">
                                    <img src="assets_cc/images/about/01.svg" alt="about">
                                </div>
                                <p>30k Video Class</p>
                            </div>
                        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    ...
                    <div class="banefites-main-wrapper">
                        ...
                        <div class="single-benifits">
                            <div class="icon">
                                <img src="assets_cc/images/benefits/01.svg" alt="banefits">
                            </div>
                            <div class="information">
                        ...
                        <div class="single-benifits">
                            <div class="icon">
                                <img src="assets_cc/images/benefits/02.svg" alt="banefits">
                            </div>
                            <div class="information">
                        ...
                        <div class="single-benifits mt--10">
                            <div class="icon">
                                <img src="assets_cc/images/benefits/03.svg" alt="banefits">
                            </div>
                            <div class="information">
                        ...
                        <div class="single-benifits mt--10">
                            <div class="icon">
                                <img src="assets_cc/images/benefits/04.svg" alt="banefits">
                            </div>
                            <div class="information">
                ...
                <div class="col-lg-6 offset-lg-1 mt_sm--30 mt_md--50 mt_sm--50">
                    <div class="thumbnail-benefits-right-image">
                        <img src="assets_cc/images/benefits/01.jpg" alt="benefits">
