                ...
                <div class="col-lg-3 rts-sticky-column-item">
                    <div class="left-sindebar-dashboard  theiaStickySidebar">
                        ...
                        <div class="dashboard-left-single-wrapper mt--40">
                            ...
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="withdrowals.php" class="single-item active">
                    ...
                    <div class="announcements-wrapper-dashed">
                        <div class="top-announcement-wrapper">
                            <div class="left-wrapper">
                                <div class="icon">
                                    <img src="assets_cc/images/dashboard/announcement/02.png" alt="announcement">
                                </div>
                        ...
                        <div class="withdrow-inner-wrapper">
                            <div class="top">
                                <i class="fa-regular fa-circle-exclamation"></i>
                                <p>The preferred payment method is selected as PayPal. You can change your <a href="#">Withdraw Preference</a> </p>
                            </div>
                            <div class="mid">
                                <img src="assets_cc/images/dashboard/announcement/03.png" alt="announcement">
                            </div>
                            <p class="pb--50">No Data Available in this Section</p>
                        </div>
                    </div>
                </div>
            </div>
