...
<?php include "include_cc/header.php"; ?>
    ...
    <!-- banner area start -->
    <div class="banner-area-six shape-move">
            ...
            <div class="container">
                <div class="row align-items-center">
                        ...
                        <div class="banner-content-one">
                            <div class="inner">
                                <div class="pre-title-banner">
                                    <img src="assets_cc/images/banner/globe.png" width="22" alt="icon">
                                    <span>Language Journey Starts Here</span>
                                </div>
                    ...
                    <div class="banner-right-img">
                        <img src="assets_cc/images/banner/14.png" alt="banner">
                    </div>
                </div>
            </div>
            <div class="shape-image">
                <img class="shape one" data-speed="0.04" data-revert="true" src="assets_cc/images/banner/shape/banner-shape01.svg" alt="">
            </div>
        </div>
    </div>
    <!-- banner area end -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-area-center-style">
                        <div class="pre-title">
                            <img src="assets_cc/images/banner/globe.png" alt="icon">
                            <span>Top Category</span>
                        </div>
                        <h2 class="title">Most spoken languages</h2>
            ...
            <div class="row g-5 justify-content-center mt--10">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    ...
                    <a href="course-one.php" class="single-category-2 v-6">
                        <div class="icon">
                            <img src="assets_cc/images/category/uk.png" alt="category">
                        </div>
                        <div class="information">
                            <h5 class="title">English Language</h5>
                            <p>130+ Courses</p>
                        </div>
                    </a>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    ...
                    <a href="course-one.php" class="single-category-2 v-6">
                        <div class="icon">
                            <img src="assets_cc/images/category/spain.png" alt="category">
                        </div>
                        <div class="information">
                            <h5 class="title">Spanish Language</h5>
                            <p>230+ Courses </p>
                        </div>
                    </a>
                    <!-- single course category end -->
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    ...
                    <a href="course-one.php" class="single-category-2 v-6">
                        <div class="icon">
                            <img src="assets_cc/images/category/germany.png" alt="category">
                        </div>
                        <div class="information">
                            <h5 class="title">German Language</h5>
                            <p>140+ Courses</p>
                        </div>
                    </a>
                    <!-- single course category end -->
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    ...
                    <a href="course-one.php" class="single-category-2 v-6">
                        <div class="icon">
                            <img src="assets_cc/images/category/france.png" alt="category">
                        </div>
                        <div class="information">
                            <h5 class="title">France Language</h5>
                            <p>130+ Courses</p>
                        </div>
                    </a>
                    <!-- single course category end -->
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    ...
                    <a href="course-one.php" class="single-category-2 v-6">
                        <div class="icon">
                            <img src="assets_cc/images/category/portugal.png" alt="category">
                        </div>
                        <div class="information">
                            <h5 class="title">Portuguese Language</h5>
                            <p>330+ Courses</p>
                        </div>
                    </a>
                    <!-- single course category end -->
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    ...
                    <a href="course-one.php" class="single-category-2 v-6">
                        <div class="icon">
                            <img src="assets_cc/images/category/russia.png" alt="category">
                        </div>
                        <div class="information">
                            <h5 class="title">Russian Language</h5>
                            <p>110+ Courses</p>
                        </div>
                    </a>
                    <!-- single course category end -->
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    ...
                    <a href="course-one.php" class="single-category-2 v-6">
                        <div class="icon">
                            <img src="assets_cc/images/category/bangladesh.png" alt="category">
                        </div>
                        <div class="information">
                            <h5 class="title">Bengali Language</h5>
                            <p>60+ Courses</p>
                        </div>
                    </a>
                    <!-- single course category end -->
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    ...
                    <a href="course-one.php" class="single-category-2 v-6">
                        <div class="icon">
                            <img src="assets_cc/images/category/japan.png" alt="category">
                        </div>
                        <div class="information">
                            <h5 class="title">Japanese Language</h5>
                            <p>150+ Courses</p>
                        </div>
                    </a>
                    <!-- single course category end -->
    ...
    <div class="feature-course-area v-6 rts-section-gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-area-left-style text-center">
                        ...
                        <h2 class="title">Language Course</h2>
                        <p class="post-title">You'll find something to spark your curiosity and enhance</p>
                    </div>
                </div>
            </div>
            <div class="row g-5 mt--30">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="rts-single-course">
                        <a href="single-course.php" class="thumbnail">
                            <img src="assets_cc/images/course/08.jpg" alt="course">
                        </a>
                        <div class="save-icon" data-bs-toggle="modal" data-bs-target="#exampleModal-login">
                            <i class="fa-sharp fa-light fa-bookmark"></i>
                        </div>
            ...
            <div class="button-area mt--50">
                <a href="#" class="rts-btn btn-primary with-arrow m-auto">View All Teacher</a>
            </div>
        </div>
    </div>
    <!-- feature course end -->
    ...
    <!-- rts fun facts start -->
    <div class="fun-facts-area-1 bg_image shape-move ptb--50">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="fun-facts-main-wrapper-1">
                        ...
                        <div class="single-fun-facts">
                            ...
                            <h5 class="title"><span class="counter animated fadeInDownBig">65,972</span></h5>
                        ...
                        <div class="single-fun-facts">
                            ...
                            <h5 class="title"><span class="counter animated fadeInDownBig">5,321</span></h5>
                        ...
                        <div class="single-fun-facts">
                            ...
                            <h5 class="title"><span class="counter animated fadeInDownBig">44,239</span></h5>
                        ...
                        <div class="single-fun-facts">
                            ...
                            <h5 class="title"><span class="counter animated fadeInDownBig">75,992</span></h5>
                            <span class="enr">Students Enrolled</span>
                        </div>
                        <!-- single end -->
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="single-blog-style-one">
                        ...
                        <div class="button-area">
                            <a href="blog-details.php" class="rts-btn btn-primary readmore-btn">Read More <i class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
