                ...
                <div class="col-lg-12">
                    <div class="single-course-left-align-wrapper">
                        ...
                        <div class="author-area">
                            <div class="author">
                                <img src="assets_cc/images/breadcrumb/01.png" alt="breadcrumb">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-8 order-cl-1 order-lg-1 order-md-2 order-sm-2 order-2">
                    <!-- course top inroll and loginto intoll area -->
                    <div class="course-top-enroll-area">
                        <div class="single-course-top">
                            <span>Current Status</span>
                            <a href="#" class="rts-btn btn-primary">Not Enrolled</a>
                        </div>
                        <div class="single-course-top">
                            <span>Price</span>
                        ...
                        <div class="single-course-top">
                            ...
                            <a href="#" class="rts-btn btn-primary">Login to Enroll</a>
                        </div>
                    </div>
                    <!-- course top inroll and loginto intoll area end -->
                    <div class="course-details-btn-wrapper materials full-width pb--50">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link meterals active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">
                                    <i class="fa-regular fa-calendar-lines-pen"></i>
                                    Course
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link meterals " id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false"><i class="fa-solid fa-calendar-week"></i>Materials</button>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content mt--50" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="course-content-wrapper-main course-content-wrapper">
                                <h5 class="title mb--20">Course Materials</h5>
                ...
                <div class="col-lg-4 order-cl-2 order-lg-2 order-md-1 order-sm-1 order-1  rts-sticky-column-item">
                    ...
                    <div class="right-course-details mt--0">
                        ...
                        <div class="course-side-bar">
                            <div class="thumbnail">
                                <img src="assets_cc/images/course/20.jpg" alt="">
