...
<?php include "include_cc/header.php"; ?>
    ...
    <div class="banner-two-flow-1920">
        <div class="banner-area-one v-2 bg_image shape-move">
                ...
                <div class="row">
                        ...
                        <div class="banner-content-one">
                            <div class="inner">
                                <div class="pre-title-banner">
                                    <img src="assets_cc/images/banner/bulb-3.png" width="22" alt="icon">
                                    <span>Gateway to Lifelong Learning</span>
                                </div>
                                <h1 class="title-banner">
                                    Welcome to Your Online
                                    <span>Learning Journey</span>
                                    <img src="assets_cc/images/banner/06.png" alt="banner">
                                </h1>
                    ...
                    <div class="col-lg-6 order-xl-2 order-lg-2 order-md-1 order-sm-1 order-1">
                        <div class="banner-right-img">
                            <img src="assets_cc/images/banner/05.png" alt="banner">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="banner-shape-area-two shape-image">
                <img src="assets_cc/images/banner/shape/16.png" data-speed="0.04" alt="one" class=" shape one">
                <img src="assets_cc/images/banner/shape/17.png" data-speed="0.04" data-revert="true" alt="two" class=" shape two">
                <img src="assets_cc/images/banner/shape/18.png" data-speed="0.04" alt="three" class=" shape three">
                <img src="assets_cc/images/banner/shape/19.png" data-speed="0.04" data-revert="true" alt="four" class=" shape four">
            </div>
        ...
        <div class="container">
            ...
            <div class="row g-5 mt--30">
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    ...
                    <a href="course-one.php" class="single-category-2">
                        <div class="icon">
                            <img src="assets_cc/images/category/01.svg" alt="category">
                        </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    ...
                    <a href="course-one.php" class="single-category-2">
                        <div class="icon">
                            <img src="assets_cc/images/category/02.svg" alt="category">
                        </div>
                        <div class="information">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    ...
                    <a href="course-one.php" class="single-category-2">
                        <div class="icon">
                            <img src="assets_cc/images/category/03.svg" alt="category">
                        </div>
                        <div class="information">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    ...
                    <a href="course-one.php" class="single-category-2">
                        <div class="icon">
                            <img src="assets_cc/images/category/04.svg" alt="category">
                        </div>
                        <div class="information">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    ...
                    <a href="course-one.php" class="single-category-2">
                        <div class="icon">
                            <img src="assets_cc/images/category/05.svg" alt="category">
                        </div>
                        <div class="information">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    ...
                    <a href="course-one.php" class="single-category-2">
                        <div class="icon">
                            <img src="assets_cc/images/category/06.svg" alt="category">
                        </div>
                        <div class="information">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    ...
                    <a href="course-one.php" class="single-category-2">
                        <div class="icon">
                            <img src="assets_cc/images/category/07.svg" alt="category">
                        </div>
                        <div class="information">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    ...
                    <a href="course-one.php" class="single-category-2">
                        <div class="icon">
                            <img src="assets_cc/images/category/08.svg" alt="category">
                        </div>
                        <div class="information">
                ...
                <div class="col-lg-6">
                    <div class="course-add-single-one bg_image bg-p">
                        <div class="title-area-left-style">
                            <div class="pre-title">
                                <img src="assets_cc/images/banner/bulb-4.png" alt="icon">
                                <span>New Course </span>
                            </div>
                            <h2 class="title">Enroll Now and Save Big <br>
                                on Quality Learning</h2>
                            <a href="course-five.php" class="rts-btn btn-primary-white">View Course</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="course-add-single-one bg_image bg-y">
                        <div class="title-area-left-style">
                            <div class="pre-title">
                                <img src="assets_cc/images/banner/bulb-5.png" alt="icon">
                                <span>New Course </span>
                            </div>
                            <h2 class="title">Limited-Time Offer: Enroll <br>
                                Today for Big Savings</h2>
                            <a href="course-five.php" class="rts-btn btn-primary hov--white">Enroll Now</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="why-choose-us bg-blue bg-choose-us-one bg_image rts-section-gap shape-move">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 pl--90 mt_md--50 mt_sm--20 pl_md--15 pl_sm--10">
                    ...
                    <a href="course-five.php" class="rts-btn btn-primary-white with-arrow">View All Course <i class="fa-regular fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
        <div class="shape-image">
            ...
            <div class="shape three" data-speed="0.04" data-revert="true"><img src="assets_cc/images/banner/16.png" alt=""></div>
        </div>
    </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="assets_cc/images/brand/08.svg" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="assets_cc/images/brand/09.svg" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="assets_cc/images/brand/10.svg" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="assets_cc/images/brand/11.svg" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="assets_cc/images/brand/12.svg" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="assets_cc/images/brand/13.svg" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                            </div>
