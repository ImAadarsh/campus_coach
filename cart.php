                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-main-wrapper">
                        ...
                        <div class="pagination-wrapper">
                            ...
                            <a class="active" href="Instructor.php">Cart</a>
                        </div>
                            ...
                            <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents">
                                ...
                                <tbody>
                                    <tr class="woocommerce-cart-form__cart-item cart_item">
                                        ...
                                        <td class="product-thumbnail">
                                            <a href="product-details.php">
                                                <img src="assets_cc/images/shop/01.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="">
                                            </a>
                                        </td>
                                        <td class="product-name" data-title="Product">
                                            <a href="product-details.php">How to change your mind</a>
                                        </td>
                                    ...
                                    <tr class="woocommerce-cart-form__cart-item cart_item">
                                        ...
                                        <td class="product-thumbnail">
                                            <a href="product-details.php">
                                                <img src="assets_cc/images/shop/02.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Shop Image">
                                            </a>
                                        </td>
                                        <td class="product-name" data-title="Product">
                                            <a href="product-details.php">The Alchemist</a>
                                        </td>
                                        <td class="product-price" data-title="Price">
                                            <span class="woocommerce-Price-amount amount">
                                    ...
                                    <tr class="woocommerce-cart-form__cart-item cart_item">
                                        ...
                                        <td class="product-thumbnail">
                                            <a href="product-details.php">
                                                <img src="assets_cc/images/shop/03.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Shop Image">
                                            </a>
                                        </td>
                                        <td class="product-name" data-title="Product">
                                            <a href="product-details.php">Spies Sadiest & Sorcerers</a>
                                        </td>
                                    ...
                                    <tr class="woocommerce-cart-form__cart-item cart_item">
                                        ...
                                        <td class="product-thumbnail">
                                            <a href="product-details.php">
                                                <img src="assets_cc/images/shop/04.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="">
                                            </a>
                                        </td>
                                        <td class="product-name" data-title="Product">
                                            <a href="product-details.php">Cannivalism</a>
                                        </td>
                                        <td class="product-price" data-title="Price">
                                            <span class="woocommerce-Price-amount amount">
