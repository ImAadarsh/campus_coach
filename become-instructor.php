                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-main-wrapper">
                        ...
                        <div class="pagination-wrapper">
                            ...
                            <a class="active" href="become-instructor.php">Become an Instructor</a>
                        </div>
        ...
        <div class="container-2">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="becomeinstructor--wrapper">
                        <div class="title-top-wrapper mb--50 mb--50">
                            <h2 class="title">How to Become an Instructor</h2>
                            <p class="disc">
                                Becoming an instructor involves a series of steps that may vary depending on the type of instruction you're interested
                            </p>
                        </div>
                        <div class="large-image-thumb">
                            <img src="assets_cc/images/instructor/14.jpg" alt="instructor">
                        </div>
                    </div>
                    <!-- becoming instructor area end -->

                    <!-- become a instructor tabs  -->
                    <div class="becom-instructor-tabs-area-wrapper mt--50">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="becom-instructor-tabs-content">
                                    <div class="">
                                        <p class="disc">
                                        ...
                                        <h6 class="title">Identify Your Area of Expertise:</h6>
                                        <p class="disc">
                                            Determine the subject or skill in which you have expertise and are passionate about teaching.
                                        </p>
                                        <h6 class="title">Educational Qualifications:</h6>
                                        <p class="disc">
                                    ...
                                    <div class="right-side">
                                        <div class="thumbnail">
                                            <img src="assets_cc/images/instructor/15.jpg" alt="instructor">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="becom-an-instructor-form-area rts-section-gapTop pl--120 pr--120 pl_sm--10 pr_sm--10">
                        <div class="title-instructor-wrapper">
                            <h2 class="title">Become an Instructor Today</h2>
                            <p class="disc">
                                Join the world's largest online learning marketplace.
                                Start teaching today
                            </p>
                        </div>
                        <form action="#" class="instructor-form">
                            <h5 class="title">Instructor Registration</h5>
                            <p class="disc">Join a supportive network that empowers you on your journey to becoming an effective and successful online educator.</p>
                            ...
                            <div class="single-checkbox-filter">
                                <div class="check-box">
                                    ...
                                    <label for="category-1">Accept the Terms and Privacy Policy</label><br>
                                </div>
                            </div>
                            <button class="rts-btn btn-primary mb--30">Register as Instructor</button>
