...
<?php include "include_cc/header.php"; ?>
                    ...
                    <div class="about-inner-right-two">
                        <div class="what-you-get">
                            ...
                            <div class="single-facilityes">
                                <div class="icon">
                                    <img src="assets_cc/images/about/icon/06.png" alt="icon-image">
                                </div>
                                <div class="information">
                                    <h5 class="title">Wide Range</h5>
                                    <p>Choose from a wide variety
                                        courses spanning.</p>
                                </div>
                            </div>
                            ...
                            <div class="single-facilityes">
                                <div class="icon">
                                    <img src="assets_cc/images/about/icon/07.png" alt="icon-image">
                                </div>
                                <div class="information">
                        ...
                        <div class="author-area">
                            ...
                            <div class="autho-sign-area">
                                <img src="assets_cc/images/about/signature.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="rts-fun-facts-area-3 bg_image rts-section-gap bg-dark-image">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex justify-content-end justify-content-sm-center mt_sm--50">
    ...
    <div class="rts-video-area">
        <div class="container">
            <div class="thumbnail mb--30" style="position: relative;">
                <img class="w-100" src="assets_cc/images/fun-facts/03.jpg" alt="">
    ...
    <!-- rts fun facts area start -->
    <div class="fun-facts-area-4 pt--100">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
