            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-main-wrapper">
                        <h1 class="title">Blog Right Sidebar</h1>
                        <!-- breadcrumb pagination area -->
                        <div class="pagination-wrapper">
                            <a href="index.php">Home</a>
                            <i class="fa-regular fa-chevron-right"></i>
                            <a class="active" href="Instructor.php">Blog Right Sidebar</a>
                        </div>
                ...
                <div class="col-xl-8 col-md-12 col-sm-12 col-12">
                    <div class="row g-5">
                        ...
                        <div class="col-lg-6">
                            <div class="single-blog-style-one">
                                <a href="blog-details.php" class="thumbnail">
                                    <img src="assets_cc/images/blog/03.jpg" alt="blog">
                                </a>
                                <div class="blog-top-area">
                                    <div class="single">
                                        <i class="fa-light fa-calendar-days"></i>
                        ...
                        <div class="col-lg-6">
                            <div class="single-blog-style-one">
                                <a href="blog-details.php" class="thumbnail">
                                    <img src="assets_cc/images/blog/07.jpg" alt="blog">
                                </a>
                                <div class="blog-top-area">
                                    <div class="single">
                                        <i class="fa-light fa-calendar-days"></i>
                        ...
                        <div class="col-lg-6">
                            <div class="single-blog-style-one">
                                <a href="blog-details.php" class="thumbnail">
                                    <img src="assets_cc/images/blog/08.jpg" alt="blog">
                                </a>
                                <div class="blog-top-area">
                                    <div class="single">
                                        <i class="fa-light fa-calendar-days"></i>
                        ...
                        <div class="col-lg-6">
                            <div class="single-blog-style-one">
                                <a href="blog-details.php" class="thumbnail">
                                    <img src="assets_cc/images/blog/06.jpg" alt="blog">
                                </a>
                                <div class="blog-top-area">
                                    <div class="single">
                                        <i class="fa-light fa-calendar-days"></i>
