...
<html lang="en">
  ...
  <?php include "include/canvas.php" ?>
        ...
        <section class="about-activities-section-2 section-padding pt-0" id="about">
        ...
        <section class="program-section-2 section-padding fix" id="programs">
            <div class="line-1">
        ...
        <!-- Team Section Start -->
        <section class="team-section-2 section-bg section-padding" id="team">
            <div class="top-shape">
        ...
        <!-- News Section Start -->
        <section class="news-section-2 fix section-padding" id="blog">
