                                ...
                                <div class="right-information">
                                    <ul class="rts-dropdown-menu switcher-language">
                                        <li class="has-child-menu">
                                            <a href="#">
                                                <img class="left-image" src="assets_cc/images/flag-01.svg" alt="Language Images">
                                            ...
                                            <ul class="sub-menu">
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="assets_cc/images/flag-03.svg" alt="Language Images">
                                                        <span class="menu-item">Deutsch</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="assets_cc/images/flag-02.svg" alt="Language Images">
                                                        <span class="menu-item">Portuguese</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="assets_cc/images/flag-04.svg" alt="Language Images">
                                            ...
                                            <ul class="submenu">
                                                <li class="sub-dropdown">
                                                    ...
                                                    <ul class="submenu third-lvl base">
                                                        ...
                                                        <li><a class="mobile-menu-link" href="quiz-attempts.php">Quiz Attempts</a></li>
                                                ...
                                                <li class="sub-dropdown">
                                                    ...
                                                    <ul class="submenu third-lvl base">
                                                        ...
                                                        <li><a class="mobile-menu-link" href="student-quiz-attempts.php">Quiz Attempts</a></li>
                    ...
                    <div class="dashboard-banner-area-start bg_image">
                        ...
                        <div class="author-profile-image-and-name">
                            <div class="profile-pic">
                                <img src="assets_cc/images/dashboard/01.png" alt="dashboard">
                            </div>
            ...
            <div class="row g-5">
                <div class="col-lg-3 rts-sticky-column-item">
                    <div class="left-sindebar-dashboard  theiaStickySidebar">
                        <div class="dashboard-left-single-wrapper">
                            ...
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="wishlist.php" class="single-item">
                            ...
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="quiz-attempts.php" class="single-item active">
                            ...
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="question-answer.php" class="single-item">
                                <i class="fa-regular fa-circle-question"></i>
                                <p>Question & Answer</p>
                            </a>
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="calender.php" class="single-item">
                        ...
                        <div class="dashboard-left-single-wrapper mt--40">
                            ...
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="my-bundles.php" class="single-item">
                            ...
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="withdrowals.php" class="single-item">
                                <i class="fa-regular fa-box"></i>
                                <p>Withdrawals</p>
                            </a>
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="assignments.php" class="single-item">
                                <i class="fa-regular fa-page"></i>
                                <p>Assignments</p>
                            </a>
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="certificate.php" class="single-item">
                ...
                <div class="col-lg-9">
                    <div class="rts-reviewd-area-dashed table-responsive" style="white-space: nowrap;">
                        <h5 class="title">My Quiz Attempsts</h5>
                        <table class="table-reviews quiz">
                            <thead>
                                <tr>
                                    <th style="width: 46%;">Quiz Info</th>
                                    <th style="width: 8%;">Question</th>
                                    <th style="width: 8%;">Total Marks</th>
                                    <th style="width: 5%;">CA</th>
                                    <th style="width: 5%;">IA</th>
                                    <th style="width: 10%;">Earned Marks</th>
                                ...
                                <tr>
                                    <td>
                                        <div class="information-quiz">
                                            ...
                                            <p class="quiz">Flavio from Spain at EF Boston</p>
                                            <p><span class="quiz">Students:</span> Richard</p>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="questions">1</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="#" class="rts-btn btn-border">Details</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
...
<?php include "include_cc/cart.php"; ?>
        ...
        <div class="mobile-menu-main">
            <nav class="nav-main mainmenu-nav mt--30">
                <ul class="mainmenu metismenu" id="mobile-menu-active">
                    ...
                    <li class="has-droupdown">
                        <a href="#" class="main" aria-expanded="true">Course</a>
                        ...
                        <ul class="submenu mm-collapse">
                            <li class="has-droupdown third-lvl">
                                ...
                                <ul class="submenu-third-lvl mm-collapse">
                                    ...
                                    <li><a href="zoom-details.php"></a>Quick Attempts</li>
                                    <li><a href="zoom-details.php"></a>Order History</li>
                                    <li><a href="zoom-details.php"></a>Question Answer</li>
                                    <li><a href="zoom-details.php"></a>Calender</li>
                                    <li><a href="zoom-details.php"></a>My Course</li>
                                    <li><a href="zoom-details.php"></a>Announcement</li>
                                    <li><a href="zoom-details.php"></a>Assignments</li>
                                    <li><a href="zoom-details.php"></a>Certificate</li>
                                </ul>
                            </li>
                            <li class="has-droupdown third-lvl">
                    ...
                    <li class="has-droupdown">
                        ...
                        <ul class="submenu mm-collapse">
                            <li><a class="mobile-menu-link" href="service.php">Service</a></li>
                            <li><a class="mobile-menu-link" href="service-details.php">Service Details</a></li>
                        </ul>
                    </li>
                    <li class="has-droupdown">
    ...
    <div class="search-input-area">
        <div class="container">
            <div class="search-input-inner">
                <div class="input-div">
                    <input id="autocomplete" class="search-input" type="text" placeholder="Search by keyword or #">
    ...
    <!-- scripts -->
    <script src="assets_cc/js/vendor/jquery.min.js"></script>
    <script src="assets_cc/js/vendor/jquery-ui.js"></script>
    <script src="assets_cc/js/vendor/waw.js"></script>

    <script src="assets_cc/js/vendor/metismenu.js"></script>
    <!-- gsap plugins end-->

    <script src="assets_cc/js/vendor/magnifying-popup.js"></script>

    <!-- swiper JS 10.2.0 -->
    <script src="assets_cc/js/plugins/swiper.js"></script>
    <script src="assets_cc/js/plugins/counterup.js"></script>
    <script src="assets_cc/js/vendor/waypoint.js"></script>
    <script src="assets_cc/js/vendor/waw.js"></script>

    <!-- isotop mesonary -->
    <script src="assets_cc/js/plugins/isotop.js"></script>
    <script src="assets_cc/js/plugins/imagesloaded.pkgd.min.js"></script>
    <!-- isotop mesonary end-->

    <script src="assets_cc/js/plugins/resizer-sensor.js"></script>
    <script src="assets_cc/js/plugins/sticky-sidebar.js"></script>
    <script src="assets_cc/js/plugins/twinmax.js"></script>

    <script src="assets_cc/js/vendor/chroma.min.js"></script>
    <!-- bootstrap 5.0.2 -->
    <script src="assets_cc/js/plugins/bootstrap.min.js"></script>
    <!-- dymanic Contact Form -->
    <script src="assets_cc/js/plugins/contact.form.js"></script>
    <script src="assets_cc/js/plugins/calender.js"></script>

    <!-- main Js -->
    <script src="assets_cc/js/main.js"></script>
