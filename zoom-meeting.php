...
<?php include "include_cc/header.php"; ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-main-wrapper">
                        <h1 class="title">Zoom Meetings and Webinars</h1>
                        <!-- breadcrumb pagination area -->
                        <div class="pagination-wrapper">
                            <a href="index.php">Home</a>
                            <i class="fa-regular fa-chevron-right"></i>
                            <a class="active" href="event-details.php">Zoom Meetings</a>
                        </div>
    ...
    <!-- rts zoom meeting area start -->
    <div class="rts-zoom-meeting-area rts-section-gapTop">
        <div class="container pb_md--100 pb_sm--80">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <!-- single zoom meeting area start -->
                    <div class="single-zoom-meeting-area">
                        <a href="zoom-details.php" class="thumbnail">
                            <img src="assets_cc/images/zoom/01.jpg" alt="">
                        </a>
                        <div class="inner-content">
                            ...
                            <a href="zoom-details.php">
                                <h5 class="title">Insights from Industry Experts</h5>
                            </a>
                            <div class="bottom">
                                <div class="left">
                                    <img src="assets_cc/images/zoom/01.png" alt="left">
                                    <span>Meeting ID:</span>
                                </div>
                                <a href="tel:+4733378901">512475523222</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-zoom-meeting-area">
                        <a href="zoom-details.php" class="thumbnail">
                            <img src="assets_cc/images/zoom/02.jpg" alt="">
                        </a>
                        <div class="inner-content">
                            <div class="head">
                                <div class="single">
                            ...
                            <a href="zoom-details.php">
                                <h5 class="title">Tips for Confident Communication</h5>
                            </a>
                            <div class="bottom">
                                <div class="left">
                                    <img src="assets_cc/images/zoom/01.png" alt="left">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-zoom-meeting-area">
                        <a href="zoom-details.php" class="thumbnail">
                            <img src="assets_cc/images/zoom/03.jpg" alt="">
                        </a>
                        <div class="inner-content">
                            <div class="head">
                                <div class="single">
                            ...
                            <a href="zoom-details.php">
                                <h5 class="title">From Idea to Business Plan</h5>
                            </a>
                            <div class="bottom">
                                <div class="left">
                                    <img src="assets_cc/images/zoom/01.png" alt="left">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-zoom-meeting-area">
                        <a href="zoom-details.php" class="thumbnail">
                            <img src="assets_cc/images/zoom/04.jpg" alt="">
                        </a>
                        <div class="inner-content">
                            <div class="head">
                                <div class="single">
                            ...
                            <a href="zoom-details.php">
                                <h5 class="title">An Introductory Guide</h5>
                            </a>
                            <div class="bottom">
                                <div class="left">
                                    <img src="assets_cc/images/zoom/01.png" alt="left">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-zoom-meeting-area">
                        <a href="zoom-details.php" class="thumbnail">
                            <img src="assets_cc/images/zoom/05.jpg" alt="">
                        </a>
                        <div class="inner-content">
                            <div class="head">
                                <div class="single">
                            ...
                            <a href="zoom-details.php">
                                <h5 class="title">Building a Greener Future</h5>
                            </a>
                            <div class="bottom">
                                <div class="left">
                                    <img src="assets_cc/images/zoom/01.png" alt="left">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-zoom-meeting-area">
                        <a href="zoom-details.php" class="thumbnail">
                            <img src="assets_cc/images/zoom/06.jpg" alt="">
                        </a>
                        <div class="inner-content">
                            <div class="head">
                                <div class="single">
                            ...
                            <a href="zoom-details.php">
                                <h5 class="title">Strategies for Success in Algebra</h5>
                            </a>
                            <div class="bottom">
                                <div class="left">
                                    <img src="assets_cc/images/zoom/01.png" alt="left">
