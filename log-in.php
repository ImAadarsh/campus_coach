                ...
                <div class="col-lg-12">
                    <div class="header-tranaparent-main-wrapper">
                        ...
                        <div class="right-area">
                            ...
                            <a href="registration.php" class="rts-btn btn-primary-white">Sign Up</a>
            ...
            <div class="row g-0">
                    ...
                    <div class="login-page-form-area">
                        ...
                        <form action="#">
                            ...
                            <div class="google-apple-wrapper">
                                <div class="google">
                                    <img src="assets_cc/images/contact/06.png" alt="contact">
                                </div>
                                <div class="google">
                                    <img src="assets_cc/images/contact/07.png" alt="contact">
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="contact-thumbnail-login-p mt--100">
                        <img src="assets_cc/images/banner/login-bg.png" width="600" height="495" alt="login-form">
                    </div>
                </div>
            </div>
        </div>
