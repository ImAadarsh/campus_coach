    ...
    <body>
                                    ...
                                    <nav id="mobile-menu">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <ul class="submenu">
                                                    <li><a href="program.php">Programs Grid</a></li>
                                                    <li><a href="program-carousel.php">Programs Carousel</a></li>
                                                    <li><a href="program-details.php">Programs Details</a></li>
                                                </ul>
                                            </li>
                                            <li class="has-dropdown">
                                                ...
                                                <ul class="submenu">
                                                    <li class="has-dropdown">
                                                        ...
                                                        <ul class="submenu">
                                                                <li><a href="event.php">Event Grid</a></li>
                                                    ...
                                                    <li class="has-dropdown">
                                                        ...
                                                        <ul class="submenu">
                                                            <li><a href="team.php">Our Teacher</a></li>
                                                            <li><a href="team-carousel.php">Teacher Carousel</a></li>
                                                            <li><a href="team-details.php">Teacher Details</a></li>
                                                        </ul>
                                                    </li>
            ...
            <div class="swiper hero-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="slider-image bg-cover" style="background-image: url('assets/img/hero/slider-1.png');">
                            ...
                            <div class="doll-shape" data-animation="fadeInLeft" data-delay="2.3s">
                                <img src="assets/img/hero/doll.png" alt="shape-img">
                            </div>
                            ...
                            <div class="bee-shape" data-animation="fadeInUp" data-delay="2.5s">
                                <img src="assets/img/hero/bee-2.png" alt="shape-img">
                            </div>
                                ...
                                <div class="row g-4 align-items-center">
                                    <div class="col-lg-8">
                                        <div class="hero-content">
                                            <h5  data-animation="fadeInUp" data-delay="1.3s">Welcome to Kidsa</h5>
                                            <h1 data-animation="fadeInUp" data-delay="1.5s">
                                                Trial Nanny Free <br> On <span>First Day.</span>
                                            </h1>
                                            <p data-animation="fadeInUp" data-delay="1.7s">
                                                Suspendisse eget lectus vitae elit malesuada lacinia Vestibulum <br> scelerisque, ligula sit amet consequat
                                            </p>
                                            <div class="hero-button">
                                                <a href="about.php" data-animation="fadeInUp" data-delay="1.7s" class="theme-btn hover-white">
                                                    Explore More
                                                    <i class="fa-solid fa-arrow-right-long"></i>
                                                </a>
                                                <a href="contact.php" data-animation="fadeInUp" data-delay="1.7s" class="theme-btn transparent-2">
                                                    Get In Touch
                                                    <i class="fa-solid fa-arrow-right-long"></i>
                                                </a>
                                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="slider-image bg-cover" style="background-image: url('assets/img/hero/slider-2.png');">
                            <div class="parasuit-shape" data-animation="fadeInLeft" data-delay="2.1s">
                                <img src="assets/img/hero/parasuit.png" alt="shape-img">
                            </div>
                            <div class="doll-shape" data-animation="fadeInLeft" data-delay="2.3s">
                    ...
                    <div class="swiper-slide">
                        <div class="slider-image bg-cover" style="background-image: url('assets/img/hero/slider-3.png');">
                            <div class="parasuit-shape" data-animation="fadeInLeft" data-delay="2.1s">
                                <img src="assets/img/hero/parasuit.png" alt="shape-img">
                            </div>
                            <div class="doll-shape" data-animation="fadeInLeft" data-delay="2.3s">
        ...
        <section class="about-section-2 fix section-padding">
            <div class="left-shape">
                <img src="assets/img/about/line-shape.png" alt="shape-img">
            </div>
            <div class="frame-shape">
                <img src="assets/img/about/frame.png" alt="shape-img">
            </div>
            <div class="container">
                            ...
                            <div class="about-content">
                                <div class="section-title">
                                    ...
                                    <h2 class="wow fadeInUp" data-wow-delay=".3s">
                                        Welcome to best Kidsa <br> for your child
                                    </h2>
                                </div>
                                <p class="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                                    Luctus. Curabitur nibh justo imperdiet non ex non tempus faucibus urna Aliquam at elit vitae dui sagittis maximus eget vitae diam In fermentum 
                                </p>
                                <div class="row g-4 mt-4">
                                    <div class="col-xl-6 col-lg-8 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                                        <div class="icon-items">
                                            <div class="icon">
                                                <img src="assets/img/about/icon-7.svg" alt="img">
                                            </div>
                                            <div class="content">
                                                <h5>Our Mission</h5>
                                    ...
                                    <div class="col-xl-6 col-lg-8 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                                        <div class="icon-items">
                                            <div class="icon">
                                                <img src="assets/img/about/icon-8.svg" alt="img">
                                            </div>
                                            <div class="content">
                                                <h5>Our Vision</h5>
        ...
        <section class="clases-section section-padding bg-cover" style="background-image: url('assets/img/clases-bg.jpg');">
            ...
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2 class="text-white wow fadeInUp" data-wow-delay=".3s">We meet kids at their level <br> regardless of their age</h2>
                </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="clases-items">
                                ...
                                <div class="clases-content">
                                    <h4>
                                        <a href="program-details.php">English Classes</a>
                                    </h4>
                        ...
                        <div class="swiper-slide">
                            <div class="clases-items">
                                ...
                                <div class="clases-content">
                                    <h4>
                                        <a href="program-details.php">Tutoring Individual</a>
                                    </h4>
                                    <p>Nulla a auctor leo. Vestibulum viverra mattis arcu <br> nec viverra. Vivamus </p>
                                    <ul class="clases-schedule">
                                        <li>
                        ...
                        <div class="swiper-slide">
                            <div class="clases-items">
                                ...
                                <div class="clases-content">
                                    <h4>
                                        <a href="program-details.php">Tutoring Online</a>
                                    </h4>
                                    <p>Nulla a auctor leo. Vestibulum viverra mattis arcu <br> nec viverra. Vivamus </p>
                                    <ul class="clases-schedule">
                                        <li>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="service-left">
                                <div class="section-title">
                                    <span class="wow fadeInUp">my Services</span>
                                    <h2 class="wow fadeInUp" data-wow-delay=".3s">
                                ...
                                <div class="about-author wow fadeInUp" data-wow-delay=".3s">
                                    <div class="about-button">
                                        <a href="contact.php" class="theme-btn">
                                            Book A visit <i class="fa-solid fa-arrow-right-long"></i>
                                        </a>
                                    </div>
                                    <div class="author-icon wow fadeInUp" data-wow-delay=".5s">
                                       <div class="icon">
                        ...
                        <div class="col-lg-6">
                            <div class="service-right">
                                <div class="icon-items wow fadeInUp" data-wow-delay=".3s">
                                    <div class="icon">
                                        <img src="assets/img/program/icon/05.svg" alt="icon-img">
                                    </div>
                                    <div class="content">
                                        <h5>Maths</h5>
                                        <p>Adipiscing elit Praesent luctus laoreet iaculis <br> Curabitur rutrum lectus augue, ut pulvinar.</p>
                                    </div>
                                </div>
                                <div class="icon-items style-2 wow fadeInUp" data-wow-delay=".5s">
                                    <div class="icon color-2">
                                        <img src="assets/img/program/icon/06.svg" alt="icon-img">
                                    </div>
                                    <div class="content">
                                        <h5>Bible Studies</h5>
                                        <p>Adipiscing elit Praesent luctus laoreet iaculis <br> Curabitur rutrum lectus augue, ut pulvinar.</p>
                                ...
                                <div class="icon-items wow fadeInUp" data-wow-delay=".7s">
                                    <div class="icon color-3">
                                        <img src="assets/img/program/icon/07.svg" alt="icon-img">
                                    </div>
                                    <div class="content">
                                        <h5>Flex-care</h5>
                                        <p>Adipiscing elit Praesent luctus laoreet iaculis <br> Curabitur rutrum lectus augue, ut pulvinar.</p>
                    ...
                    <div class="marquee-inner to-left">
                        <ul class="marqee-list d-flex">
                            <li class="marquee-item">
                                <span class="text-slider"><img src="assets/img/asterisk.svg" alt="img"></span><span class="text-slider">2024 Social Media</span>
                                <span class="text-slider"><img src="assets/img/asterisk.svg" alt="img"></span><span class="text-slider text-color">Most Impact</span>
                                <span class="text-slider"><img src="assets/img/asterisk.svg" alt="img"></span><span class="text-slider">Award Wining</span>
                                <span class="text-slider"><img src="assets/img/asterisk.svg" alt="img"></span><span class="text-slider text-color">2023 Maths </span>
                                <span class="text-slider"><img src="assets/img/asterisk.svg" alt="img"></span><span class="text-slider">2024 Social Media</span>
                                <span class="text-slider"><img src="assets/img/asterisk.svg" alt="img"></span><span class="text-slider text-color">Most Impact</span>
                                <span class="text-slider"><img src="assets/img/asterisk.svg" alt="img"></span><span class="text-slider">Award Wining</span>
                                <span class="text-slider"><img src="assets/img/asterisk.svg" alt="img"></span><span class="text-slider text-color">2023 Maths </span>
        ...
        <div class="certificate-section section-padding pt-0">
            <div class="container">
                <div class="swiper certificate-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="certificate-image">
                                <img src="assets/img/certifigate-1.jpg" alt="img">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="certificate-image">
                                <img src="assets/img/certifigate-2.jpg" alt="img">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="certificate-image">
                                <img src="assets/img/certifigate-3.jpg" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="pricing-section section-bg section-padding">
            ...
            <div class="girl-shape float-bob-y">
                <img src="assets/img/pricing/girl.png" alt="shape-img">
            </div>
            <div class="top-shape">
                <img src="assets/img/top-shape.png" alt="shape-img">
            </div>
            <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                                <div class="pricing-items">
                                    <div class="icon">
                                        <img src="assets/img/pricing/icon.svg" alt="icon-img">
                                     </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                                <div class="pricing-items active">
                                    <div class="icon">
                                     ...
                                     <div class="element-shape">
                                        <img src="assets/img/pricing/element-2.png" alt="shape-img">
                                     </div>
                                    <div class="pricing-header">
                                        <h4>Premium Plan</h4>
        ...
        <!-- Event Section Start -->
        <section class="event-section section-padding bg-cover" style="background-image: url('assets/img/event-bg.jpg');">
            ...
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2 class="text-white wow fadeInUp" data-wow-delay=".3s">Upcoming school activities & <br> events schedule</h2>
                </div>
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
        ...
        <!-- Cta Section Start -->
        <section class="cta-section-2 section-padding fix bg-cover" style="background-image: url('assets/img/cta/cta-bg-2.png');">
            <div class="parasuit-shape float-bob-y">
                <img src="assets/img/cta/parasuit-1.png" alt="shape-img">
            </div>
            <div class="parasuit-shape-2 float-bob-x">
                <img src="assets/img/cta/parasuit-2.png" alt="shape-img">
            </div>
            <div class="pencil-shape">
                <img src="assets/img/cta/pencil-3.png" alt="shape-img">
            </div>
            <div class="hand-shape">
                <img src="assets/img/cta/hand.png" alt="shape-img">
            </div>
            <div class="line-shape">
                <img src="assets/img/cta/line.png" alt="shape-img">
            </div>
            <div class="container">
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-6">
                            <div class="section-title">
                                ...
                                <h2 class="text-white wow fadeInUp" data-wow-delay=".3s">Skills certificate from  the Kidsa</h2>
                            </div>
                            <a href="contact.php" class="theme-btn bg-white mt-4 mt-md-0 wow fadeInUp" data-wow-delay=".5s">Apply Now <i class="fa-solid fa-arrow-right-long"></i></a>
                        </div>
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay=".4s">
                            <div class="cta-image-area">
                                <div class="bg-shape">
                                    <img src="assets/img/cta/cta-shape-3.png" alt="shape-img">
                                </div>
                                <div class="cta-image">
                                    <img src="assets/img/cta/cta-3.png" alt="img">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="single-footer-widget">
                            ...
                            <div class="footer-content style-two">
                                ...
                                <a href="contact.php" class="theme-btn">contact Us<i class="fa-solid fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
