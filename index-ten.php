...
<body>
                    ...
                    <div class="header-one-wrapper">
                        ...
                        <div class="header-right-area-one">
                            ...
                            <div class="buttons-area">
                                <a href="registration.php" class="rts-btn btn-primary">Join Now</a>
                            </div>
    ...
    <!-- banner area ten start -->
    <div class="banner-area-ten bg_banner-ten bg_image shape-move">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 order-xl-1 order-lg-1 order-md-2 order-sm-2 order-2">
                    <!-- banner content ten -->
                    <div class="banner-content-ten-start ptb_md--50 ptb_sm--50">
                        <div class="pre-title">
                            <img src="assets_cc/images/banner/33.png" alt="pre-title">
                        ...
                        <div class="banner-button-area">
                            <a href="#" class="rts-btn btn-primary-white">Find Course</a>
                            <img src="assets_cc/images/banner/arrow-1.png" alt="arrow">
                        </div>
                    </div>
                    <!-- banner content ten end -->
                </div>
                <div class="col-lg-6 order-xl-2 order-lg-2 order-md-1 order-sm-1 order-1">
                    <div class="thumbnail-banner-10">
                        <img src="assets_cc/images/banner/32.png" alt="banner">
                    </div>
                </div>
            </div>
        </div>
        <div class="banner-shape-area shape-image">
            <img src="assets_cc/images/banner/shape/10.png" alt="shape" class="shape one" data-speed="0.04" data-revert="true">
            <img src="assets_cc/images/banner/shape/11.png" alt="shape" class="shape two" data-speed="0.04">
            <img src="assets_cc/images/banner/shape/12.png" alt="shape" class="shape three" data-speed="0.04" data-revert="true">
            <img src="assets_cc/images/banner/shape/13.png" alt="shape" class="shape four" data-speed="0.04" data-revert="true">
            <img src="assets_cc/images/banner/shape/14.png" alt="shape" class="shape five" data-speed="0.04">
            <img src="assets_cc/images/banner/shape/15.png" alt="shape" class="shape six" data-speed="0.04" data-revert="true">
        </div>
    </div>
    <!-- banner area ten end -->
    ...
    <div class="rts-service-area rts-section-gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-area-center-style">
                        ...
                        <h2 class="title">Our Dedicated Business <br>
            ...
            <div class="row mt--70">
                <div class="col-lg-12">
                    <div class="rts-service-main-wrapper-area">
                        <!-- single service start -->
                        <div class="single-service-start">
                            <div class="icon">
                                <img src="assets_cc/images/service/01.svg" alt="service">
                            </div>
                        ...
                        <div class="single-service-start">
                            <div class="icon">
                                <img src="assets_cc/images/service/02.svg" alt="service">
                            </div>
                            <div class="information">
                                <h5 class="title">Business Strategy</h5>
                                <span>30+ Courses</span>
                        ...
                        <div class="single-service-start">
                            <div class="icon">
                                <img src="assets_cc/images/service/03.svg" alt="service">
                            </div>
                            <div class="information">
                                <h5 class="title">Marketing Guide</h5>
                                <span>30+ Courses</span>
                            </div>
                        </div>
                        <!-- single service end -->
                        ...
                        <div class="single-service-start">
                            <div class="icon">
                                <img src="assets_cc/images/service/04.svg" alt="service">
                            </div>
                            <div class="information">
                                <h5 class="title">Team Building</h5>
                                <span>30+ Courses</span>
                            </div>
                        </div>
                        <!-- single service end -->
                        ...
                        <div class="single-service-start">
                            <div class="icon">
                                <img src="assets_cc/images/service/05.svg" alt="service">
                            </div>
                            <div class="information">
                        ...
                        <div class="single-service-start">
                            <div class="icon">
                                <img src="assets_cc/images/service/06.svg" alt="service">
                            </div>
                            <div class="information">
                                <h5 class="title">Human Resource</h5>
                                <span>30+ Courses</span>
                            </div>
                        </div>
                        <!-- single service end -->
                        ...
                        <div class="single-service-start">
                            <div class="icon">
                                <img src="assets_cc/images/service/07.svg" alt="service">
                            </div>
                            <div class="information">
                    ...
                    <div class="upcoming-events-main-wrapper-1">
                        ...
                        <div class="single-upcoming-events">
                            <div class="img-information">
                                <a href="event-details.php" class="thumbnail">
                                    <img src="assets_cc/images/events/01.jpg" alt="events">
                                </a>
                                <div class="information">
                        ...
                        <div class="single-upcoming-events">
                            <div class="img-information">
                                <a href="event-details.php" class="thumbnail">
                                    <img src="assets_cc/images/events/02.jpg" alt="events">
                                </a>
                                <div class="information">
                                    <div class="date-details">
                                        <div class="date">
                        ...
                        <div class="single-upcoming-events">
                            <div class="img-information">
                                <a href="event-details.php" class="thumbnail">
                                    <img src="assets_cc/images/events/03.jpg" alt="events">
                                </a>
                                <div class="information">
                                    <div class="date-details">
                                        <div class="date">
    ...
    <!-- feedback area start -->
    <div class="rts-feedback-area rts-section-gap shape-move">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-area-center-style">
            ...
            <div class="row mt--50">
                <div class="col-lg-12">
                    <div class="students-feedback-wrapper-1 background-2 bg_image">
                        <div class="swiper mySwiper-testimonials-1">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-students-feedback">
                                        <div class="left-image">
                                            <img src="assets_cc/images/students-feedback/06.jpg" alt="feedback">
                                        </div>
                                        <div class="right-content">
                                            <img src="assets_cc/images/students-feedback/16.png" alt="feedback">
                                            <p class="disc">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-students-feedback">
                                        <div class="left-image">
                                            <img src="assets_cc/images/students-feedback/02.jpg" alt="feedback">
                                        </div>
                                        <div class="right-content">
                                            <img src="assets_cc/images/students-feedback/16.png" alt="feedback">
                                            <p class="disc">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-students-feedback">
                                        <div class="left-image">
                                            <img src="assets_cc/images/students-feedback/01.jpg" alt="feedback">
                                        </div>
                                        <div class="right-content">
                                            <img src="assets_cc/images/students-feedback/16.png" alt="feedback">
                                            <p class="disc">
                        ...
                        <div class="shape-image">
                            <div class="shape one" data-speed="0.04" data-revert="true"><img src="assets_cc/images/students-feedback/14.png" alt=""></div>
                            <div class="shape three" data-speed="0.04"><img src="assets_cc/images/students-feedback/15.png" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="brand-area-nine-start rts-section-gapBottom">
        <div class="container pb--120">
            <div class="row">
                <div class="col-lg-12">

                    <div class="brand-swiper-10-wrapper">
                        <div class="swiper swiper-data" data-swiper='{
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-brand-10">
                                        <img src="assets_cc/images/brand/08.svg" alt="brnad">
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <!-- single brand area start -->
                                    <div class="single-brand-10">
                                        <img src="assets_cc/images/brand/09.svg" alt="brnad">
                                    </div>
                                    <!-- single brand area end -->
                                </div>
                                <div class="swiper-slide">
                                    <!-- single brand area start -->
                                    <div class="single-brand-10">
                                        <img src="assets_cc/images/brand/10.svg" alt="brnad">
                                    </div>
                                    <!-- single brand area end -->
                                </div>
                                <div class="swiper-slide">
                                    <!-- single brand area start -->
                                    <div class="single-brand-10">
                                        <img src="assets_cc/images/brand/11.svg" alt="brnad">
                                    </div>
                                    <!-- single brand area end -->
                                </div>
                                <div class="swiper-slide">
                                    <!-- single brand area start -->
                                    <div class="single-brand-10">
                                        <img src="assets_cc/images/brand/12.svg" alt="brnad">
                                    </div>
                                    <!-- single brand area end -->
                                </div>
                                <div class="swiper-slide">
                                    <!-- single brand area start -->
                                    <div class="single-brand-10">
                                        <img src="assets_cc/images/brand/13.svg" alt="brnad">
                                    </div>
                                    <!-- single brand area end -->
                                </div>
    ...
    <div class="footer-callto-action-area bg-white">
        ...
        <div class="container pt--105 pb--60">
            <div class="row">
                <div class="col-lg-12">
                    <!-- footer main wrapper -->
                    <div class="footer-one-main-wrapper">
                        ...
                        <div class="footer-singl-wized left-logo">
                            <div class="head">
                                <a href="#">
                                    <img src="assets_cc/images/logo/logo-1.svg" alt="logo" loading="lazy">
                                </a>
                            </div>
                            <div class="body">
                                <p class="dsic">
                                ...
                                <ul class="wrapper-list">
                                    ...
                                    <li><a href="tel:+4733378901"><i class="fa-regular fa-phone"></i>+(61) 485-826-710</a></li>
                                </ul>
                            </div>
                        </div>
