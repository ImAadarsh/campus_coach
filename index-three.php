...
<body>
                    ...
                    <div class="header-one-wrapper">
                        <div class="left-side-header">
                            <a href="index.php" class="logo-area">
                                <img src="assets_cc/images/logo/logo-1.svg" alt="logo">
                            </a>
    ...
    <div class="rts-banner-area-3 shape-move banner-review banner-three-bg rts-section-gap bg_image">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-three-wrapper">
                        <div class="title-area-center-style">
                            ...
                            <h1 class="title">Find the Perfect Course for <br>
                                <span>Your Carrier Goals</span>
                                <img src="assets_cc/images/banner/shape/04.png" alt="shape">
                            </h1>
                            <form action="#">
        ...
        <div class="banner-three-images shape-image">
            <div class="shape left-top" data-speed="0.04">
                <img src="assets_cc/images/banner/10.png" alt="banner">
            </div>
            <div class="shape left-bottom" data-speed="0.04" data-revert="true">
                <img src="assets_cc/images/banner/11.png" alt="banner">
            </div>
            <div class="shape right-center">
                <img src="assets_cc/images/banner/09.png" alt="banner">
            </div>
        </div>
        <div class="shape-area shape-image">
            <img class="shape one" src="assets_cc/images/banner/shape/01.png" data-speed="0.04" data-revert="true" alt="shape">
            <img class="shape two" src="assets_cc/images/banner/shape/02.png" data-speed="0.04" alt="shape">
            <img class="shape three" src="assets_cc/images/banner/shape/03.png" data-speed="0.04" alt="shape">
            <img class="shape four" src="assets_cc/images/banner/shape/03.svg" data-speed="0.04" data-revert="true" alt="shape">
            <img class="shape five" src="assets_cc/images/banner/shape/04.svg" data-speed="0.04" alt="shape">
            <img class="shape six" src="assets_cc/images/banner/shape/05.svg" data-speed="0.04" data-revert="true" alt="shape">
        </div>
        <div class="review-thumb">
            <!-- single review -->
            <div class="review-single">
                <img src="assets_cc/images/banner/07.png" alt="banner">
    ...
    <!-- rts- barand area two -->
    <div class="rts-brand-style-two ptb--80 ptb_md--60 ptb_sm--50">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h6 class="title">We collaborate with 300+ leading universities and companies</h6>
                </div>
            </div>
            <div class="row mt--40">
                <div class="col-gl-12">
                    <div class="brand-area-main-wrapper-2">
                        <div class="swiper-brand-wrapper-2">
                            <div class="swiper swiper-data" data-swiper='{
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        ...
                                        <img src="assets_cc/images/brand/01.svg" alt="brand">
                                        <!-- single course style two end -->
                                    </div>
                                    <div class="swiper-slide">
                                        <!-- single course style two -->
                                        <img src="assets_cc/images/brand/02.svg" alt="brand">
                                        <!-- single course style two end -->
                                    </div>
                                    <div class="swiper-slide">
                                        <!-- single course style two -->
                                        <img src="assets_cc/images/brand/03.svg" alt="brand">
                                        <!-- single course style two end -->
                                    </div>
                                    <div class="swiper-slide">
                                        <!-- single course style two -->
                                        <img src="assets_cc/images/brand/04.svg" alt="brand">
                                        <!-- single course style two end -->
                                    </div>
                                    <div class="swiper-slide">
                                        <!-- single course style two -->
                                        <img src="assets_cc/images/brand/05.svg" alt="brand">
                                        <!-- single course style two end -->
                                    </div>
                                    <div class="swiper-slide">
                                        <!-- single course style two -->
                                        <img src="assets_cc/images/brand/06.svg" alt="brand">
                                        <!-- single course style two end -->
                                    </div>
                                    <div class="swiper-slide">
                                        <!-- single course style two -->
                                        <img src="assets_cc/images/brand/07.svg" alt="brand">
                                        <!-- single course style two end -->
                                    </div>
                                </div>
                ...
                <div class="col-lg-12">
                    <div class="title-between-area align-items-end">
                        <div class="title-area-left-style">
                            ...
                            <h2 class="title">Explore new and trending <br>
                        ...
                        "1500":{
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-course-style-three">
                                        <a href="single-course.php" class="thumbnail">
                                            <img src="assets_cc/images/course/01.jpg" alt="course">
                                            <div class="tag-thumb">
                                                <span>Marketing</span>
                                            </div>
                                        </a>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-course-style-three">
                                        <a href="single-course.php" class="thumbnail">
                                            <img src="assets_cc/images/course/02.jpg" alt="course">
                                            <div class="tag-thumb">
                                                <span>Marketing</span>
                                            </div>
                                        </a>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-course-style-three">
                                        <a href="single-course.php" class="thumbnail">
                                            <img src="assets_cc/images/course/03.jpg" alt="course">
                                            <div class="tag-thumb">
                                                <span>Marketing</span>
                                            </div>
                                        </a>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-course-style-three">
                                        <a href="single-course.php" class="thumbnail">
                                            <img src="assets_cc/images/course/04.jpg" alt="course">
                                            <div class="tag-thumb">
                                                <span>Marketing</span>
                                            </div>
                                        </a>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-course-style-three">
                                        <a href="single-course.php" class="thumbnail">
                                            <img src="assets_cc/images/course/05.jpg" alt="course">
                                            <div class="tag-thumb">
                                                <span>Marketing</span>
                                            </div>
                                        </a>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-course-style-three">
                                        <a href="single-course.php" class="thumbnail">
                                            <img src="assets_cc/images/course/06.jpg" alt="course">
                                            <div class="tag-thumb">
                                                <span>Marketing</span>
                                            </div>
                                        </a>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-course-style-three">
                                        <a href="single-course.php" class="thumbnail">
                                            <img src="assets_cc/images/course/07.jpg" alt="course">
                                            <div class="tag-thumb">
                                                <span>Marketing</span>
                                            </div>
                                        </a>
    ...
    <!-- top category start -->
    <div class="top-category-area rts-section-gap bg-category-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-area-center-style">
            ...
            <div class="row mt--20 g-5">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    <!-- single category -->
                    <div class="category-single-list">
                        <a href="course-one.php" class="thumbnail">
                            <img src="assets_cc/images/course/01.png" alt="course">
                        </a>
                        <div class="information">
                            <a href="course-one.php">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="category-single-list">
                        <a href="course-one.php" class="thumbnail">
                            <img src="assets_cc/images/course/02.png" alt="course">
                        </a>
                        <div class="information">
                            <a href="course-one.php">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="category-single-list">
                        <a href="course-one.php" class="thumbnail">
                            <img src="assets_cc/images/course/03.png" alt="course">
                        </a>
                        <div class="information">
                            <a href="course-one.php">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="category-single-list">
                        <a href="course-one.php" class="thumbnail">
                            <img src="assets_cc/images/course/04.png" alt="course">
                        </a>
                        <div class="information">
                            <a href="course-one.php">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="category-single-list">
                        <a href="course-one.php" class="thumbnail">
                            <img src="assets_cc/images/course/05.png" alt="course">
                        </a>
                        <div class="information">
                            <a href="course-one.php">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="category-single-list">
                        <a href="course-one.php" class="thumbnail">
                            <img src="assets_cc/images/course/06.png" alt="course">
                        </a>
                        <div class="information">
                            <a href="course-one.php">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="category-single-list">
                        <a href="course-one.php" class="thumbnail">
                            <img src="assets_cc/images/course/07.png" alt="course">
                        </a>
                        <div class="information">
                            <a href="course-one.php">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="category-single-list">
                        <a href="course-one.php" class="thumbnail">
                            <img src="assets_cc/images/course/08.png" alt="course">
                        </a>
                        <div class="information">
                            <a href="course-one.php">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="category-single-list">
                        <a href="course-one.php" class="thumbnail">
                            <img src="assets_cc/images/course/09.png" alt="course">
                        </a>
                        <div class="information">
                            <a href="course-one.php">
                                <h6 class="title">Teaching & Academics</h6>
                            </a>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="category-single-list">
                        <a href="course-one.php" class="thumbnail">
                            <img src="assets_cc/images/course/10.png" alt="course">
                        </a>
                        <div class="information">
                            <a href="course-one.php">
                                <h6 class="title">Ethical Hacking</h6>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="category-single-list">
                        <a href="course-one.php" class="thumbnail">
                            <img src="assets_cc/images/course/11.png" alt="course">
                        </a>
                        <div class="information">
                            <a href="course-one.php">
                                <h6 class="title">Health & Fitness</h6>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="category-single-list">
                        <a href="course-one.php" class="thumbnail">
                            <img src="assets_cc/images/course/12.png" alt="course">
                        </a>
                        <div class="information">
                            <a href="course-one.php">
                                <h6 class="title">Teaching & Academics</h6>
        ...
        <div class="container">
            ...
            <div class="ms-portfolio-filter-area main-isotop">
                <div class="portfolio_wrap">
                    <div class="filter g-5 mt--20 row portfolio-feed personal">
                        <div class="flash grid-item-p element-item transition creative col-xl-3 col-lg-4 col-md-6 col-sm-12" data-category="transition">
                            <!-- single course style two -->
                            <div class="single-course-style-three">
                                <a href="single-course.php" class="thumbnail">
                                    <img src="assets_cc/images/course/01.jpg" alt="course">
                                ...
                                <div class="body-area">
                                    ...
                                    <div class="course-content-area">
                                        ...
                                        <div class="button-area">
                                            <a href="cart.php" class="rts-btn btn-primary">Add To Cart</a>
                        ...
                        <div class="flash grid-item-p element-item transition design col-xl-3 col-lg-4 col-md-6 col-sm-12" data-category="transition">
                            <!-- single course style two -->
                            <div class="single-course-style-three">
                                <a href="single-course.php" class="thumbnail">
                                    <img src="assets_cc/images/course/02.jpg" alt="course">
                        ...
                        <div class="flash grid-item-p element-item transition photo col-xl-3 col-lg-4 col-md-6 col-sm-12" data-category="transition">
                            <!-- single course style two -->
                            <div class="single-course-style-three">
                                <a href="single-course.php" class="thumbnail">
                                    <img src="assets_cc/images/course/03.jpg" alt="course">
                        ...
                        <div class="flash grid-item-p element-item transition style col-xl-3 col-lg-4 col-md-6 col-sm-12" data-category="transition">
                            <!-- single course style two -->
                            <div class="single-course-style-three">
                                <a href="single-course.php" class="thumbnail">
                                    <img src="assets_cc/images/course/04.jpg" alt="course">
                        ...
                        <div class="flash grid-item-p element-item transition design col-xl-3 col-lg-4 col-md-6 col-sm-12" data-category="transition">
                            ...
                            <div class="single-course-style-three">
                                ...
                                <div class="body-area">
                                    ...
                                    <a href="single-course.php">
                                        <h5 class="title">Statistics for Data Science and Business Analysis</h5>
                                    </a>
                                    <div class="teacher-stars">
                                        <div class="teacher"><span>Dr. Angela Yu</span></div>
                                        <ul class="stars">
                        ...
                        <div class="flash grid-item-p element-item transition photo col-xl-3 col-lg-4 col-md-6 col-sm-12" data-category="transition">
                            ...
                            <div class="single-course-style-three">
                                ...
                                <div class="body-area">
                                    ...
                                    <a href="single-course.php">
                                        <h5 class="title">For Data Science and Business Analysis</h5>
                                    </a>
                                    <div class="teacher-stars">
                                        <div class="teacher"><span>Dr. Angela Yu</span></div>
                                        <ul class="stars">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="title-area-left-style">
                        ...
                        <h2 class="title mb--30">Register Your Account Get free <br>
                            access to 60000 online course
                            <img src="assets_cc/images/fun-facts/01.png" alt="fun-facts">
                        </h2>
                        <div class="counter-remaining-area" id="timer">
                            <!-- single counter -->
                ...
                <div class="col-lg-6 d-flex justify-content-end mt_md--50 mt_sm--50">
                    <div class="registration-area-right">
                        <h4 class="title">Fill Your Registration</h4>
                        <form action="#" class="registration">
                            ...
                            <button class="rts-btn btn-primary">Registration Now </button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="thumbnail-jointeam-one pl--70">
                        <img src="assets_cc/images/instructor/02.png" alt="join">
                        <div class="shape-area-one shape-image">
                            <img src="assets_cc/images/instructor/shape/01.png" alt="shape" data-speed="0.04" class=" shape one">
                            <img src="assets_cc/images/instructor/shape/02.png" alt="shape" data-speed="0.04" data-revert="true" class=" shape two">
                            <img src="assets_cc/images/instructor/shape/03.png" alt="shape" data-speed="0.04" class=" shape three">
                            <img src="assets_cc/images/instructor/shape/04.png" alt="shape" data-speed="0.04" data-revert="true" class=" shape four">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="title-area-left-style">
                        ...
                        <a href="become-instructor.php" class="rts-btn btn-primary with-arrow">Join Us <i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="shape-area shape-image">
            <img src="assets_cc/images/instructor/shape/05.png" data-speed="0.04" alt="shape" class="shape">
        </div>
    </div>
    ...
    <div class="students-feedback-area rts-section-gap">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-4 ">
                                            <div class="testimonials-wrapper-left">
                                                <img src="assets_cc/images/students-feedback/04.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-8 pl--60 pl_md--20 pl_sm--15 mt_sm--20 mt_md--20">
                                            <div class="inner-testimonials">
                                                <div class="quote">
                                                    <img src="assets_cc/images/students-feedback/10.png" alt="feedback">
                                                </div>
                                                <p class="disc">
                                                ...
                                                <div class="author-area">
                                                    <img src="assets_cc/images/students-feedback/11.png" alt="students">
                                                    <div class="information">
        ...
        <div class="shape-area">
            <img src="assets_cc/images/students-feedback/12.png" alt="feedback">
        </div>
    </div>
        ...
        <div class="container rts-section-gapBottom">
            ...
            <div class="row mt--20 g-5">
                <div class="col-xl-6 col-lg-12 col-md-12 col-12">
                    ...
                    <div class="single-blog-list-wrapper">
                        <a href="blog-details.php" class="thumbnail">
                            <img src="assets_cc/images/blog/04.jpg" alt="blog">
                        </a>
                ...
                <div class="col-xl-6 col-lg-12 col-md-12 col-12">
                    ...
                    <div class="single-blog-list-wrapper">
                        <a href="blog-details.php" class="thumbnail">
                            <img src="assets_cc/images/blog/05.jpg" alt="blog">
                        </a>
                        <div class="information-blog">
                            <div class="tag"><span>Marketing</span></div>
                            <a href="blog-details.php">
                    ...
                    <div class="call-to-sction bg_image shape-move">
                        <div class="title-area-left-style">
                            ...
                            <div class="finding-source">
                                <a href="#">
                                    <img src="assets_cc/images/cta/01.svg" alt="cta-one">
                                </a>
                                <a href="#">
                                    <img src="assets_cc/images/cta/02.svg" alt="cta-one">
                                </a>
                            </div>
                        </div>
                        <div class="image-right">
                            <img src="assets_cc/images/cta/03.png" alt="cta-main">
                        </div>
                        <div class="banner-shape-area-two shape-image">
                            <img src="assets_cc/images/cta/03.svg" data-speed="0.04" alt="one" class="shape one">
                            <img src="assets_cc/images/cta/05.svg" data-speed="0.04" data-revert="true" alt="two" class=" shape two">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="footer-one-main-wrapper">
                        ...
                        <div class="footer-singl-wized left-logo">
                            <div class="head">
                                <a href="#">
                                    <img src="assets_cc/images/logo/logo-2.svg" alt="logo" loading="lazy">
                                </a>
                            </div>
                            <div class="body">
                                <p class="dsic">
                                ...
                                <ul class="wrapper-list">
                                    ...
                                    <li><a href="call-to:61485826710"><i class="fa-regular fa-phone"></i>+(61) 485-826-710</a></li>
                                </ul>
                            </div>
                        </div>
