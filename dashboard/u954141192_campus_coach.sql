...
-- Session Variables
--  [name] => Aadarsh [mobile] => 9399380920 [token] => UbjzcLn59VreWLqyHRk4fJa5iCCpBkh2UNU8baGQQmulnFFWAUxbRosOJB73 [userid] => 4 [profile] => [banner] => [is_data] => 1 [is_email] => 0 [cart_id] => 4 [type] => user )
