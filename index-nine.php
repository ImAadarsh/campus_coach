...
<body>
    ...
    <!-- banner nine area start -->
    <div class="rts-banner-area-start-nine rts-section-gap bg-banner-nine shape-move">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-12">
                    <div class="banner-content-area-wrapper-left-nine">
                        <h1 class="title">Embark on a <br>
                            transformative learning <br>
                            journey at Campus Coach | Guiding Future
                            <img src="assets_cc/images/banner/line-title.png" width="313" alt="banner">
                        </h1>
                        <p class="disc">
                        ...
                        <div class="banner-button-area">
                            <a href="#" class="rts-btn btn-primary">My Course</a>
                            <img src="assets_cc/images/banner/arrow.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-12 mt_lg--50 mt_md--50 mt_sm--50">
                    <div class="banner-right-course-nine-wrapper">
                        <div class="row g-5">
                            ...
                            <div class="col-lg-6 col-md-6 mt--100 mt_sm--30">
                                <div class="rts-single-course">
                                    <a href="single-course.php" class="thumbnail">
                        ...
                        <div class="review-thumb">
                            ...
                            <div class="review-single">
                                <img src="assets_cc/images/banner/03.png" alt="banner">
                            ...
                            <div class="review-single two">
                                <img src="assets_cc/images/banner/04.png" alt="banner">
                                <div class="info-right">
                                    <h6 class="title">100+
                                    </h6>
        ...
        <div class="banner-shape shape-image">
            <img class="one shape" data-speed="0.04" data-revert="true" src="assets_cc/images/banner/bulb-6.png" width="36" alt="banner">
            <img class="two shape" data-speed="0.04" src="assets_cc/images/banner/bulb-7.png" width="49" alt="banner">
        </div>
    </div>
    <!-- banner nine area end -->

    <div class="brand-area-nine-start rts-section-gapTop">
                ...
                <div class="col-lg-12">
                    <div class="title-between-area align-items-end">
                        <div class="title-area-left-style">
                            ...
                            <p class="disc">You'll find something to spark your curiosity and enhance</p>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-area-center-style">
                        <div class="pre-title">
                            <img src="assets_cc/images/banner/bulb.png" alt="icon">
                            <span>Courses Benefit </span>
                        </div>
                        <h2 class="title">Benefits of a course portal</h2>
            ...
            <div class="row g-5 mt--10">
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <!-- single category area start nine -->
                    <div class="single-category-nine-area">
                        <div class="icon">
                            <img src="assets_cc/images/category/19.svg" alt="category">
                        </div>
                        <a href="#">
                            <h5 class="title">Flexible Learning</h5>
                        </a>
                        <p class="disc">
                            Emphasize the flexibility of your platform.
                            Whether it's self-paced courses.
                        </p>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-category-nine-area">
                        <div class="icon">
                            <img src="assets_cc/images/category/20.svg" alt="category">
                        </div>
                        <a href="#">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-category-nine-area">
                        <div class="icon">
                            <img src="assets_cc/images/category/21.svg" alt="category">
                        </div>
                        <a href="#">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-category-nine-area">
                        <div class="icon">
                            <img src="assets_cc/images/category/22.svg" alt="category">
                        </div>
                        <a href="#">
                            <h5 class="title">Responsive Support</h5>
                        </a>
                        <p class="disc">
                            Emphasize the flexibility of your platform.
                            Whether it's self-paced courses.
    ...
    <div class="about-area-start rts-section-gap">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    ...
                    <div class="about-one-left-image">
                        <div class="second-order">
                            <img src="assets_cc/images/about/07.jpg" alt="about">
                ...
                <div class="col-lg-6 pl--60 pl_md--10 pl_sm--10 mt_md--50 mt_sm--50">
                    <div class="title-area-left-style">
                        <div class="pre-title">
                            <img src="assets_cc/images/banner/bulb.png" alt="icon">
                    ...
                    <div class="about-inner-right-one">
                        <div class="what-you-get">
                            ...
                            <div class="single-facilityes">
                                <div class="icon">
                                    <img src="assets_cc/images/about/icon/01.svg" alt="icon-image">
                                </div>
                            ...
                            <div class="single-facilityes">
                                <div class="icon">
                                    <img src="assets_cc/images/about/icon/02.svg" alt="icon-image">
                                </div>
                                <div class="information">
                                    <h5 class="title">Expert Instructors</h5>
                        ...
                        <div class="author-area">
                            <a href="#" class="rts-btn btn-primary">Course Guides </a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="rts-students-feedback-area rts-section-gap bg-feedback-nine">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-students-feedback-5">
                                        ...
                                        <div class="quote">
                                            <img src="assets_cc/images/students-feedback/17.png" alt="feedback">
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-students-feedback-5">
                                        ...
                                        <div class="authore-area">
                                            <img src="assets_cc/images/students-feedback/09.png" alt="feedback">
                                            <div class="author">
                                                <h6 class="title">Emma Elizabeth</h6>
                                                <span>Assistant Teacher</span>
                                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="call-to-sction bg_image shape-move">
                        ...
                        <div class="cta-image">
                            <img src="assets_cc/images/cta/women.png" alt="">
                        </div>
                        <div class="shape-image">
                            <div class="shape one" data-speed="0.04"><img src="assets_cc/images/cta/03.svg" alt=""></div>
                            <div class="shape two" data-speed="0.04"><img src="assets_cc/images/cta/04.svg" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
