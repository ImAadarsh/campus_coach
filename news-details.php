                            ...
                            <div class="blog-post-details">
                                <div class="single-blog-post">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <div class="hilight-text mt-4 mb-4">
                                            <p>
                                                Pellentesque sollicitudin congue dolor non aliquam. Morbi volutpat, nisi vel ultricies <br> urnacondimentum, sapien neque lobortis tortor, quis efficitur mi ipsum eu metus. Praesent eleifend <br> orci sit amet est vehicula.
                                            </p>
                                            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M7.71428 20.0711H0.5V5.64258H14.9286V20.4531L9.97665 30.3568H3.38041L8.16149 20.7947L8.5233 20.0711H7.71428Z" stroke="#F39F5F"/>
                                                <path d="M28.2846 20.0711H21.0703V5.64258H35.4989V20.4531L30.547 30.3568H23.9507L28.7318 20.7947L29.0936 20.0711H28.2846Z" stroke="#F39F5F"/>
                                            </svg>
                                        </div>
                                        <p class="mt-4 mb-5">
                                ...
                                <div class="row tag-share-wrap mt-4 mb-5">
                                    <div class="col-lg-8 col-12">
                                        <div class="tagcloud">                                   
                                            <a href="news-details.php">Class</a>
                                            <a href="news-details.php">Sports</a>
                                            <a href="news-details.php">Canteen</a>
                                        </div>
                                    </div>
                                ...
                                <div class="comments-area">
                                    ...
                                    <div class="blog-single-comment d-flex gap-4 pt-4 pb-5">
                                        ...
                                        <div class="content">
                                            <div class="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                                <div class="con">
                                                    <h5><a href="news-details.php">Albert Flores</a></h5>
                                    ...
                                    <div class="blog-single-comment d-flex gap-4 pt-5 pb-5">
                                        ...
                                        <div class="content">
                                            <div class="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                                <div class="con">
                                                    <h5><a href="news-details.php">Alex Flores</a></h5>
                                                    <span>March 20, 2024 at 2:37 pm</span>
                                                </div>
                                                <div class="star">
                                                    <i class="fa-solid fa-star"></i>
                            ...
                            <div class="main-sidebar">
                                ...
                                <div class="single-sidebar-widget">
                                    ...
                                    <div class="news-widget-categories">
                                        <ul>
                                            <li><a href="news-details.php">Teachers</a> <span>(5)</span></li>
                                            <li><a href="news-details.php">Indoor Games</a> <span>(3)</span></li>
                                            <li class="active"><a href="news-details.php">Education</a><span>(6)</span></li>
                                            <li><a href="news-details.php">Canteen</a> <span>(2)</span></li>
                                            <li><a href="news-details.php">Classes</a> <span>(4)</span></li>
                                            <li><a href="news-details.php">Examination</a> <span>(7)</span></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="single-sidebar-widget">
                                ...
                                <div class="single-sidebar-widget">
                                    ...
                                    <div class="news-widget-categories">
                                        <div class="tagcloud">
                                            <a href="news-standard.php">Time-Table</a>     
                                            <a href="news-details.php">Children</a>
                                            <a href="news-details.php">Examination</a>
                                            <a href="news-details.php">Class</a>
                                            <a href="news-details.php">Sports</a>
                                            <a href="news-details.php">Canteen</a>
                                        </div>
