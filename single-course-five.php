...
<?php include "include_cc/header.php"; ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-main-wrapper">
                        <h1 class="title">Our Course Details</h1>
                        <!-- breadcrumb pagination area -->
                        <div class="pagination-wrapper">
                            <a href="index.php">Home</a>
                            <i class="fa-regular fa-chevron-right"></i>
                            <a class="active" href="Instructor.php">Our Course Details</a>
                        </div>
    ...
    <!-- rts course details area start -->
    <div class="rts-course-details-area rts-section-gap">
        <div class="container">
            <div class="row g-5">
                <div class="col-xl-8 col-lg-12 order-xl-1 order-lg-2 order-md-2 order-sm-2 order-2">
                    <!-- single course style five start -->
                    <div class="single-course-style-five">
                        <h2 class="title">The Complete Web Developer in 2023: Zero to Mastery</h2>
                        <div class="instructor-main-wrapper-course-single">
                            <div class="instructor-area  single-instructor-rating">
                                <img src="assets_cc/images/instructor/01.png" alt="instructor">
                                <div class="information">
                                    <span class="desig">Instructor:</span>
                                    <a href="#" class="name">William U. Jack</a>
                                </div>
                            </div>
                            <div class="category single-instructor-rating">
                                <span>Categories:</span>
                                <h6 class="title">Web Developments</h6>
                            </div>
                            <div class="review single-instructor-rating">
                                <span>Reviews:</span>
                            ...
                            <div class="buy-now-area single-instructor-rating">
                                <h4 class="price">$56.00</h4>
                                <a href="#" class="rts-btn btn-primary">Buy Now</a>
                            </div>
                        </div>
                        <div class="course-area-wrapper ptb--50">
                            <div class="thumbnail-area">
                                <img src="assets_cc/images/course/26.jpg" alt="">
                            </div>
                        </div>
                            ...
                            <div class="tab-pane fade " id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                ...
                                <div class="single-instructor-area-details">
                                    <a href="#" class="thumbnail">
                                        <img src="assets_cc/images/instructor/10.jpg" alt="instructor">
                                    </a>
                                ...
                                <div class="single-instructor-area-details">
                                    <a href="#" class="thumbnail">
                                        <img src="assets_cc/images/instructor/11.jpg" alt="instructor">
                                    </a>
                                    <div class="inner-instrustor-area">
                                        <h5 class="title">William U.</h5>
                                        <span class="deg">Advanced Educator</span>
                                ...
                                <div class="rating-main-wrapper">
                                    ...
                                    <div class="indevidual-rating-area">
                                        ...
                                        <div class="author-area">
                                            <img src="assets_cc/images/instructor/12.jpg" alt="instructor">
                                            <div class="information">
                                                <span>William U.</span>
                                                <div class="stars">
                                                    <i class="fa-solid fa-star"></i>
                                    ...
                                    <div class="indevidual-rating-area">
                                        <!-- author-area -->
                                        <div class="author-area">
                                            <img src="assets_cc/images/instructor/13.jpg" alt="instructor">
                                            <div class="information">
                                                <span>William U.</span>
                                                <div class="stars">
                                                    <i class="fa-solid fa-star"></i>
                    ...
                    <!-- single course style five end -->
                </div>
                <div class=" col-xl-4 col-lg-12 order-xl-2 order-lg-1 order-md-1 pl--50 pl_lg--15 pl_md--15 pl_sm--15 order-sm-1 order-1  rts-sticky-column-item">
                    <!-- right- sticky bar area -->
                    <div class="right-course-details mt--0">
                        <!-- course category area start -->
                        <div class="rts-course-category-area">
                        ...
                        <!-- latest course areas start -->
                        <div class="our-latest-course-start-right-side-bar">
                            <h5 class="title">Latest Course</h5>
                            <!-- single course list  -->
                            <div class="single-course-list-wrapper">
                                <a href="#" class="thumbnail">
                                    <img src="assets_cc/images/course/23.jpg" alt="course">
                                </a>
                                <div class="inner-content">
                                    <a href="#">
                                        <h6 class="title">The Complete Web Developer in
                                            2023: Zero to Mastery</h6>
                                    </a>
                                    <div class="pricing-area">
                                        <span class="none">$65.00</span>
                                        <span>$85.00</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single-course-list-wrapper">
                                <a href="#" class="thumbnail">
                                    <img src="assets_cc/images/course/24.jpg" alt="course">
                                </a>
                                <div class="inner-content">
                                    <a href="#">
                                        <h6 class="title">How to Write the Ultimate Page
                                            Strategic Business Plan</h6>
                                    </a>
                                    <div class="pricing-area">
                                        <span class="none">$65.00</span>
                                        <span>$85.00</span>
                            ...
                            <div class="single-course-list-wrapper">
                                <a href="#" class="thumbnail">
                                    <img src="assets_cc/images/course/25.jpg" alt="course">
                                </a>
                                <div class="inner-content">
                                    <a href="#">
                                        <h6 class="title">100 Days Of Code - 2023 Web
                                            Development Bootcamp</h6>
                                    </a>
                                    <div class="pricing-area">
                                        <span class="none">$65.00</span>
                                        <span>$85.00</span>
                        ...
                        <div class="add-area-sidebar mt--50">
                            <div class="thumbnail">
                                <img src="assets_cc/images/course/add.jpg" alt="course">
                                <div class="content">
                                    <h4 class="title">Campus Coach | Guiding Future Course Selling <br>
                                        Upto 30% Off</h4>
                                    <a href="#" class="rts-btn btn-primary black">Buy Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
