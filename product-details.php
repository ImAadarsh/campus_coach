                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-main-wrapper">
                        ...
                        <div class="pagination-wrapper">
                            ...
                            <a class="active" href="Instructor.php">Product Details</a>
                        </div>
                        ...
                        <div class="row">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="slider-inner">
                                                    <img src="assets_cc/images/shop/01.jpg" alt="full_screen-image">
                                                </div>
                                            </div>

                                            <div class="swiper-slide">
                                                <div class="slider-inner">
                                                    <img src="assets_cc/images/shop/02.jpg" alt="full_screen-image">
                                                </div>
                                            </div>

                                            <div class="swiper-slide">
                                                <div class="slider-inner">
                                                    <img src="assets_cc/images/shop/03.jpg" alt="full_screen-image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="ms-single-product__content">
                                    <h2 class="ms-single-product_title">How to change your mind</h2>
                                    <p class="price">
                                    ...
                                    <div class="product_meta">
                                        ...
                                        <span class="posted_in"><strong>Category:</strong> <a href="#0" rel="tag">For Running</a></span>
                            ...
                            <div class="col-md-12 tab-area rts-section-gap">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="messages-tab" data-bs-toggle="tab" data-bs-target="#messages" type="button" role="tab" aria-controls="messages" aria-selected="false">Review (0)</button>
                                    </li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content">
                                    <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab" tabindex="0">Credibly e-enable e-business materials with competitive products.
                                        ...
                                        intuitive collaboration and idea-sharing through high-quality models. Synergistically incubate
                                        extensible outsourcing via magnetic sources. Interactively revolutionize
                                        intuitive collaboration and idea-sharing through high-quality models. Interactively revolutionize
                                        intuitive collaboration and idea-sharing through high-quality models.
                                        <br>
                                        <br>
                                        Interactively revolutionize intuitive collaboration and idea-sharing through high-quality models. Credibly e-enable e-business materials with competitive products.
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-6 col-sm-12">
                                                                            ...
                                                                            <div class="ms-cf--bottom col-12">
                                                                                <button class="rts-btn btn btn-primary" type="submit">Submit</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                ...
                                <div class="row ms-woo-feed">
                                        ...
                                        <div class="blog-single-two-wrapper shop">
                                            <div class="image-area">
                                                <a href="product-details.php" class="thumbnail">
                                                    <img src="assets_cc/images/shop/05.jpg" alt="blog-image">
                                                </a>
                                            </div>
                                            <div class="inner">
                                                <span class="pre-tag">
                                                ...
                                                <a href="product-details.php">
                                                    <h5 class="title"> La Recta Provinca</h5>
                                                </a>
                                                <a href="cart.php" class="btn-read-more-blog">Add To Cart <i class="fa-regular fa-cart-shopping"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6">
                                        <div class="blog-single-two-wrapper shop">
                                            <div class="image-area">
                                                <a href="product-details.php" class="thumbnail">
                                                    <img src="assets_cc/images/shop/06.jpg" alt="blog-image">
                                                </a>
                                            </div>
                                            <div class="inner">
                                                <span class="pre-tag">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="blog-single-two-wrapper shop">
                                            <div class="image-area">
                                                <a href="product-details.php" class="thumbnail">
                                                    <img src="assets_cc/images/shop/07.jpg" alt="blog-image">
                                                </a>
                                            </div>
                                            <div class="inner">
                                                <span class="pre-tag">
                                                ...
                                                <a href="product-details.php">
                                                    <h5 class="title"> A Thousand Ships</h5>
                                                </a>
                                                <a href="cart.php" class="btn-read-more-blog">Add To Cart <i class="fa-regular fa-cart-shopping"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="blog-single-two-wrapper shop">
                                            <div class="image-area">
                                                <a href="product-details.php" class="thumbnail">
                                                    <img src="assets_cc/images/shop/08.jpg" alt="blog-image">
                                                </a>
                                            </div>
                                            <div class="inner">
                                                <span class="pre-tag">
                                                ...
                                                <a href="product-details.php">
                                                    <h5 class="title"> This Might Be a Hurt Bit</h5>
                                                </a>
                                                <a href="cart.php" class="btn-read-more-blog">Add To Cart <i class="fa-regular fa-cart-shopping"></i></a>
                                            </div>
                                        </div>
