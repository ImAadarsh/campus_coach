            ...
            <div class="row g-5">
                <div class="col-lg-3 rts-sticky-column-item">
                    <div class="left-sindebar-dashboard  theiaStickySidebar">
                        ...
                        <div class="dashboard-left-single-wrapper mt--40">
                            ...
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="my-bundles.php" class="single-item active">
                ...
                <div class="col-lg-9">
                    <div class="exrolled-course-wrapper-dashed">
                        <h5 class="title">My Bundles</h5>
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Publish (26)</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Pending (11)</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Draft (140)</button>
                            </li>
                        </ul>
                                ...
                                <div class="row g-5">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="rts-single-course">
                                            ...
                                            <a href="single-course.php">
                                                <h5 class="title">Coursae is Web Developer in
                                                    2023: Zero to Mastery</h5>
                                            </a>
                                            <p class="teacher">Dr. Angela Yu</p>
                                            <div class="rating-and-price">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="rts-single-course">
                                            ...
                                            <a href="single-course.php">
                                                <h5 class="title"> Web Developer in
                                                    2023: Zero to Mastery</h5>
                                            </a>
                                            <p class="teacher">Dr. Angela Yu</p>
                                            <div class="rating-and-price">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="rts-single-course">
                                            ...
                                            <a href="single-course.php">
                                                <h5 class="title">Web Developer in
                                                    2023: Zero to Mastery The Complete </h5>
                                            </a>
                                            <p class="teacher">Dr. Angela Yu</p>
                                            <div class="rating-and-price">
                                                <div class="rating-area">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="rts-single-course">
                                            ...
                                            <a href="single-course.php">
                                                <h5 class="title">Feature Web Developer in
                                                    2023: Zero to Mastery</h5>
                                            </a>
                                            <p class="teacher">Dr. Angela Yu</p>
                                            <div class="rating-and-price">
