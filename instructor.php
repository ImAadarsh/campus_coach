                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-main-wrapper">
                        ...
                        <div class="pagination-wrapper">
                            ...
                            <a class="active" href="Instructor.php">All Instructor</a>
                        </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-instructor">
                        <div class="thumbnail-img">
                            <a href="#" class="thumbnail">
                                <img src="assets_cc/images/instructor/06.jpg" alt="instructor">
                            </a>
                            <div class="social-img-instructor">
                                <ul>
                                    <li><a href="#"><i class="fa-sharp fa-light fa-share-nodes"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-instructor">
                        <div class="thumbnail-img">
                            <a href="#" class="thumbnail">
                                <img src="assets_cc/images/instructor/07.jpg" alt="instructor">
                            </a>
                            <div class="social-img-instructor">
                                <ul>
                                    <li><a href="#"><i class="fa-sharp fa-light fa-share-nodes"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-instructor">
                        <div class="thumbnail-img">
                            <a href="#" class="thumbnail">
                                <img src="assets_cc/images/instructor/08.jpg" alt="instructor">
                            </a>
                            <div class="social-img-instructor">
                                <ul>
                                    <li><a href="#"><i class="fa-sharp fa-light fa-share-nodes"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-instructor">
                        <div class="thumbnail-img">
                            <a href="#" class="thumbnail">
                                <img src="assets_cc/images/instructor/09.jpg" alt="instructor">
                            </a>
                            <div class="social-img-instructor">
                                <ul>
                                    <li><a href="#"><i class="fa-sharp fa-light fa-share-nodes"></i></a></li>
