                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-main-wrapper">
                        ...
                        <div class="pagination-wrapper">
                            ...
                            <a class="active" href="event-2.php">All Events</a>
                        </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-events-two-wrapper">
                        <a href="event-details.php" class="thumbnail">
                            <img src="assets_cc/images/events/04.jpg" alt="events-area">
                        </a>
                        <div class="inner-content-events-2">
                            ...
                            <div class="bottom">
                                ...
                                <a href="event-details.php" class="rts-btn btn-border with-arrow">Get Ticket<i class="fa-regular fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-events-two-wrapper">
                        ...
                        <div class="inner-content-events-2">
                            ...
                            <a href="event-details.php">
                                <h5 class="title">Health Fusion Expo: Holistic Wellness
                                    for the Modern Age </h5>
                            </a>
                            <div class="bottom">
                                <div class="location">
                                    <i class="fa-sharp fa-regular fa-location-dot"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-events-two-wrapper">
                        <a href="event-details.php" class="thumbnail">
                            <img src="assets_cc/images/events/09.jpg" alt="events-area">
                        </a>
                        <div class="inner-content-events-2">
                            <div class="time-line">
                                <div class="single">
                            ...
                            <a href="event-details.php">
                                <h5 class="title">Edu Confluence: Bridging Ideas,
                                    Transforming Education</h5>
                            </a>
                            <div class="bottom">
                                <div class="location">
                                    <i class="fa-sharp fa-regular fa-location-dot"></i>
