                ...
                <div class="col-lg-3 rts-sticky-column-item">
                    <div class="left-sindebar-dashboard  theiaStickySidebar">
                        <div class="dashboard-left-single-wrapper">
                            ...
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="reviews.php" class="single-item active">
                                <i class="fa-regular fa-star"></i>
                                <p>Reviews</p>
                            </a>
                            <!-- single item end -->
                            ...
                            <tbody class="">
                                    ...
                                    <td>
                                        <div class="author-area">
                                            <div class="profile-picture">
                                                <img src="assets_cc/images/dashboard/reviews/01.png" alt="reviews">
                                            </div>
                                            <p>Christopher</p>
                                        </div>
                                    </td>
                                ...
                                <tr class="odd">
                                    <td>
                                        <div class="author-area">
                                            <div class="profile-picture">
                                                <img src="assets_cc/images/dashboard/reviews/02.png" alt="reviews">
                                            </div>
                                            <p>Christopher</p>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="author-area">
                                            <div class="profile-picture">
                                                <img src="assets_cc/images/dashboard/reviews/03.png" alt="reviews">
                                            </div>
                                            <p>Christopher</p>
                                        </div>
                                    </td>
                                ...
                                <tr class="odd">
                                    <td>
                                        <div class="author-area">
                                            <div class="profile-picture">
                                                <img src="assets_cc/images/dashboard/reviews/04.png" alt="reviews">
                                            </div>
                                            <p>Daniel Jonh</p>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="author-area">
                                            <div class="profile-picture">
                                                <img src="assets_cc/images/dashboard/reviews/05.png" alt="reviews">
                                            </div>
                                            <p>Jennifer Linda</p>
                                        </div>
                                    </td>
                                ...
                                <tr class="odd">
                                    <td>
                                        <div class="author-area">
                                            <div class="profile-picture">
                                                <img src="assets_cc/images/dashboard/reviews/06.png" alt="reviews">
                                            </div>
                                            <p>Jennifer Linda</p>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="author-area">
                                            <div class="profile-picture">
                                                <img src="assets_cc/images/dashboard/reviews/07.png" alt="reviews">
                                            </div>
                                            <p>Daniel Jonh</p>
                                        </div>
                                    </td>
                                ...
                                <tr class="odd">
                                    <td>
                                        <div class="author-area">
                                            <div class="profile-picture">
                                                <img src="assets_cc/images/dashboard/reviews/08.png" alt="reviews">
                                            </div>
                                            <p>James Robert</p>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="author-area">
                                            <div class="profile-picture">
                                                <img src="assets_cc/images/dashboard/reviews/09.png" alt="reviews">
                                            </div>
                                            <p>Daniel Jonh</p>
                                        </div>
                                    </td>
                                ...
                                <tr class="odd">
                                    <td>
                                        <div class="author-area">
                                            <div class="profile-picture">
                                                <img src="assets_cc/images/dashboard/reviews/10.png" alt="reviews">
                                            </div>
                                            <p>James Robert</p>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="author-area">
                                            <div class="profile-picture">
                                                <img src="assets_cc/images/dashboard/reviews/11.png" alt="reviews">
                                            </div>
                                            <p>James Robert</p>
                                        </div>
                                    </td>
